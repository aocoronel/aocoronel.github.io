...
By the way, I wouldn't have the eager to make anything about tech, if I didn't use Linux (I use Arch, btw). The reason is simple: you have control and freedom to do anything.

Beyond that, I'm currently a Veterinary Medicine undergradute, who has a very long journey along the way.
